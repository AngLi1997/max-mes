  ...
  >
    <view class="filter-content">
      ...
      <view class="filter-item">
        ...
        <wd-input v-model="filterData.weighCentre" :placeholder="t('请输入称量中心名称/编码')" />
      </view>
      <view class="filter-item">
        <view class="item-title">
          {{ t("任务编号") }}
        </view>
        <wd-input v-model="filterData.taskNo" :placeholder="t('请输入任务编号')" />
      </view>
    </view>
  </BMModal>
  <!-- 排序 -->
  ...
  >
    <view class="sort-content">
      <view class="sort-item bottom-border">
        ...
        <wd-radio-group
          v-model="sortData.sortFinishTime"
          shape="button"
          @change="() => {
            sortData.sortSendTime = '';
            sortData.sortTaskNo = '';
          }"
        >
          <wd-radio value="finishTime asc">
            {{ t("顺序排列") }}
          </wd-radio>
          <wd-radio value="finishTime desc">
            {{ t("逆序排列") }}
          </wd-radio>
        </wd-radio-group>
      </view>
      <view class="sort-item bottom-border">
        ...
        <wd-radio-group
          v-model="sortData.sortSendTime"
          shape="button"
          @change="() => {
            sortData.sortFinishTime = '';
            sortData.sortTaskNo = '';
          }"
        >
      ...
      <view class="sort-item">
        ...
        >
          <wd-radio value="taskNo asc">
            {{ t("顺序排列") }}
          </wd-radio>
          <wd-radio value="taskNo desc">
            {{ t("逆序排列") }}
          </wd-radio>
        </wd-radio-group>
      </view>

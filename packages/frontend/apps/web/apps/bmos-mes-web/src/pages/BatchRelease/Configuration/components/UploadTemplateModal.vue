...
<script lang="tsx" setup>
  ...
  import { reqLotReleaseTemplateUploadTemplate, reqLotReleaseTemplateUploadTemplateFile } from '@/services';
  ...
  const submit = async (formModal: Recordable) => {
    try {
      await reqLotReleaseTemplateUploadTemplateFile({
        lotReleaseTemplateVersionId: props.secondRowData.id,

  ...
  export default {
    ...
    methods: {
        ...
        oWebControl = new window.WebControl({
          ...
          cbConnectError() {
            ...
            if (initCount < 3) {
              ...
              that.$message.warning(t('插件启动失败，请检查插件是否安装！'));
      ...
      init() {
        ...
        this.getPubKey(() => {
          // //////////////////////////////// 请自行修改以下变量值  ////////////////////////////////////
          let appkey = '26751218'; //综合安防管理平台提供的appkey，必填    20689287
          let secret = this.setEncrypt('4XkUsJv4Nx1ylpQdQlrw'); //综合安防管理平台提供的secret，必填  akFLZLlK5mTXHHGhmZBh
          let ip = '172.28.100.13'; //综合安防管理平台IP地址，必填  172.16.0.33

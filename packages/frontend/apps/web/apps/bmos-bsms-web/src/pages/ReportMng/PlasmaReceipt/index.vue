...
<template>
  <BMPageComponent
    ...
    :requests="[getPlasmaReceiptList as DataRequestFn]"
    :columns="[columnsFirst]">
    <template #tableHeaderToolbar0>
      <Button
        v-hasAuth="170120003000001"
        type="primary"
...
<script setup lang="ts">
  import { getPlasmaReceiptList, getPlasmaReceiptPrint } from '@/services';
  ...
  const printReceipt = async () => {
    try {
      ...
      const res = await getPlasmaReceiptPrint(data);

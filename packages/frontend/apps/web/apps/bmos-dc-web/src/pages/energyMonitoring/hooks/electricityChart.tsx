...
export const useElectricityChart = () => {
  ...
  const initChart = () => {
    // 获取 ref electricityChart 的 高度 并赋值给 height
  ...
  return {
    electricityChartDate: date,
    electricityChartPicker: picker,
    changeElectricityChartPicker: changePicker,
    electricityChartOptions: options,
    setElectricityChartInit: initChart,
    electricityChartHeight: height,
    electricityChartRef: chartRef,
    setElectricityChartData: setData,
    electricityChartIsInit: isInit,
  };
};

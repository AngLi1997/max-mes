...
/**
 * @description: 查询历史接口 /api/app/dc/log/operation/list/{businessId}
 * @param {string} businessId 业务id
 */
export const reqHistoryList = (businessId: string = '') => {
  return request({
    url: `/app/dc/operation/history/list/${businessId}`,
    method: 'GET',
  });
};
...
/**
 * @description: 查询审批历史 /api/app/dc/audit/list/flow/audit/history
...
export const getFlowAuditHistory = (processInstanceId: string, deploymentId: string) => {
  return request({
    url: `/app/dc/audit/list/flow/audit/history`,
    method: 'GET',
    params: {
      processInstanceId,
      deploymentId,
...
/**
 * @description: 任务处理-审批通过 /api/app/dc/audit/complete
 * @param {any} data 参数
 */

export const mesAuditComplete = (data: any) => {
  return request({
    url: `/app/dc/audit/complete`,
    method: 'POST',
    data,
  });
};
...
/**
 * @description: 任务处理-审批不通过 /api/app/dc/audit/complete/not/approve
 * @param {any} data 参数
 */

export const mesAuditCompleteNotApprove = (data: any) => {
  return request({
    url: `/app/dc/audit/complete/not/approve`,
    method: 'POST',
    data,
  });
};
...
/**
 * @description: 任务处理-审批不通过 /api/app/dc/audit/back/to/prev
 * @param {any} data 参数
 */

export const mesAuditBackToPrev = (data: any) => {
  return request({
    url: `/app/dc/audit/back/to/prev`,
    method: 'POST',
    data,
  });
};
...
/**
 * @description: 查询抄送人 /api/app/dc/audit/list/make/user
...
export const getFlowListMakeUser = (nodeId: string, deploymentId: string) => {
  return request({
    url: `/app/dc/audit/list/make/user`,
    method: 'GET',
    params: {
      nodeId,
      deploymentId,
...
/**
 * @description: 成品树 /app/dc/product/material/finishProductTree
...
export const getProductMaterialFinishProductTree = (categoryType: number = 2, isFinishedProduct: boolean = true) => {
  return request({
    url: `/app/dc/product/material/finishProductTree`,
    method: 'GET',
    params: {
      categoryType,
      isFinishedProduct,
...
/**
 * @description: 保存操作历史 /api/app/dc/operation/history/save
 * @param {string} businessId 业务id
...
export const operationHistorySave = (businessId: string, type: number) => {
  return request({
    url: `/app/dc/operation/history/save`,
    method: 'POST',
    data: {
      type,
      businessId,
...
/**
 * @description 根据功能权限按钮id查询用户列表  /api/app/dc/unit/calcSumAdapt

...
# 环境变量：release_type=master;root_directory=/Users/a1/script/;source_release=V3.0.0;target_release=V3.0.0_patch1;workspace_ip=localhost;workspace_pwd=nopassword;workspace_user=root;system_type=01-MES

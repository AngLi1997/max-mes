...
import com.bmos.mes.mq.consumer.impl.OpenSourceConsumerContainerBuilder;
import com.bmos.mes.mq.producer.OpenSourceRocketMqProducer;
...
@Configuration
public class OpenSourceMqConfig {
    ...
    @Primary
    @Bean
    public RocketMQMessageConverter customRocketMessageConverter(JavaTimeModule javaTimeModule,ObjectMapper objectMapper) {
        ...
        messageConverterOptional.ifPresent(messageConverter12 -> {
            ...
            mappingFastJsonMessageConverter.setObjectMapper(objectMapper);
        });

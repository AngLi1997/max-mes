package com.bmos.mes.mq.consumer.impl;

import com.bmos.mes.mq.BaseMqTopic;
import com.bmos.mes.mq.annotation.Consumer;
import com.bmos.mes.mq.consumer.ConsumerContainerBuilder;
...
public class OpenSourceConsumerContainerBuilder implements ConsumerContainerBuilder {
    ...
    public void doRegisterContainer(Class<?> targetClass, String beanName, Object bean, String topic, String groupId, Consumer consumer) {
        ...
        BaseMqTopic<Object> messageContext = (BaseMqTopic<Object>) bean;

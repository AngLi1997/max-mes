 ...
 */
package com.bmos.expression.function;
...
public class Functions {
    ...
    private static final int INDEX_LN = 31;
    ...
    static {
        BUILT_IN_FUNCTIONS[INDEX_SIN] = new Function("sin") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.sin(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_COS] = new Function("cos") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.cos(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_TAN] = new Function("tan") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.tan(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_COT] = new Function("cot") {
            ...
            public BigDecimal apply(int scale, BigDecimal... args) {
                try {
                    return BigDecimalMath.cot(args[0], new MathContext(scale));
                } catch (ArithmeticException e) {
                    throw new BmosException(BaseResponseCode.ZERO_ARG_FUN, "cot");
                }
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_LOG] = new Function("log") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.log(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_LOG2] = new Function("log2") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.log2(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_LOG10] = new Function("log10") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.log10(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_LOG1P] = new Function("log1p") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.log(args[0].add(BigDecimal.ONE), new MathContext(scale));
            }
        };
        ...
        BUILT_IN_FUNCTIONS[INDEX_ACOS] = new Function("acos") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.acos(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_ASIN] = new Function("asin") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.asin(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_ATAN] = new Function("atan") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.atan(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_CBRT] = new Function("cbrt") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimal.valueOf(Math.cbrt(args[0].doubleValue())).setScale(scale, RoundingMode.DOWN);
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_FLOOR] = new Function("floor") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return args[0].round(new MathContext(0, RoundingMode.FLOOR));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_SINH] = new Function("sinh") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.sinh(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_SQRT] = new Function("sqrt") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.sqrt(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_TANH] = new Function("tanh") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.tanh(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_COSH] = new Function("cosh") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.cosh(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_CEIL] = new Function("ceil") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return args[0].round(new MathContext(scale, RoundingMode.CEILING));
            }
        };
        ...
        BUILT_IN_FUNCTIONS[INDEX_EXP] = new Function("exp", 1) {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.exp(args[0], new MathContext(scale));
            }
        };
        ...
        BUILT_IN_FUNCTIONS[INDEX_SGN] = new Function("signum", 1) {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return new BigDecimal(args[0].signum());
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_CSC] = new Function("csc") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                BigDecimal sin = BigDecimalMath.sin(args[0], new MathContext(scale));
                if (sin.signum() == 0) {
                    throw new BmosException(BaseResponseCode.ZERO_ARG_FUN, "csc");
                }
                return BigDecimal.ONE.divide(sin, scale, RoundingMode.DOWN);
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_SEC] = new Function("sec") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                BigDecimal cos = BigDecimalMath.cos(args[0], new MathContext(scale));
                if (cos.signum() == 0) {
                    throw new BmosException(BaseResponseCode.ZERO_ARG_FUN, "sec");
                }
                return BigDecimal.ONE.divide(cos, scale, RoundingMode.DOWN);
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_CSCH] = new Function("csch") {
            ...
            public BigDecimal apply(int scale, BigDecimal... args) {
                ...
                BigDecimal sinh = BigDecimalMath.sinh(args[0], new MathContext(scale));
                return BigDecimal.ONE.divide(sinh, scale, RoundingMode.DOWN);
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_SECH] = new Function("sech") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                BigDecimal cosh = BigDecimalMath.sinh(args[0], new MathContext(scale));
                return BigDecimal.ONE.divide(cosh, scale, RoundingMode.DOWN);
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_COTH] = new Function("coth") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                BigDecimal bigDecimal = BigDecimalMath.cosh(args[0], new MathContext(scale));
                BigDecimal bigDecimal1 = BigDecimalMath.sinh(args[0], new MathContext(scale));
                return bigDecimal.divide(bigDecimal1, scale, RoundingMode.DOWN);
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_LOGB] = new Function("logb", 2) {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                BigDecimal bigDecimal = BigDecimalMath.log(args[1], new MathContext(scale));
                BigDecimal bigDecimal1 = BigDecimalMath.log(args[0], new MathContext(scale));
                return bigDecimal.divide(bigDecimal1, scale, RoundingMode.DOWN);
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_TO_RADIAN] = new Function("toradian") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.toRadians(args[0], new MathContext(scale));
            }
        };
        BUILT_IN_FUNCTIONS[INDEX_TO_DEGREE] = new Function("todegree") {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.toDegrees(args[0], new MathContext(scale));
            }
        };

        BUILT_IN_FUNCTIONS[INDEX_LN] = new Function("ln", 1) {
            @Override
            public BigDecimal apply(int scale, BigDecimal... args) {
                return BigDecimalMath.log(args[0], new MathContext(scale));
            }
    ...
    public static Function getBuiltinFunction(final String name) {
        ...
        switch (name) {
            ...
            case "ln":
                return BUILT_IN_FUNCTIONS[INDEX_LN];
            case "max":

...
import com.bmos.lims2.server.active.entity.Active;
import com.bmos.lims2.server.active.mapper.ActiveMapper;
...
public class ActiveServiceImpl implements ActiveService {
    ...
    public String save(String activeStr) {
        ...
        if (!rsaVO.getActive()){
            throw new BmosException(LimsResponseCode.ACTIVE_ERROR);
        }

...
@Setter
@ToString
@ApiModel("绑定了请验单的检品树节点DTO")
public class MaterialInspectTreeWithDocumentDTO implements TreeNode<MaterialInspectTreeWithDocumentDTO, Long, String> {
    ...
    private List<MaterialInspectTreeWithDocumentDTO> children;
    ...
    // 请验单相关字段
    @ApiModelProperty("绑定的请验单ID")
    private Long documentConfigId;

    @ApiModelProperty("绑定的请验单名称")

...
import com.bmos.lims2.server.eln.record.convert.RecordComponentConvert;
import com.bmos.lims2.server.eln.record.dto.ComponentDetailDTO;
import com.bmos.lims2.server.eln.record.dto.CopyVersionDTO;
import com.bmos.lims2.server.eln.record.dto.FormulaParameterDTO;
...
import com.bmos.lims2.server.eln.record.redis.RecordRedisKeyDefine;
...
public class BatchRecordComponentServiceImpl implements BatchRecordComponentService {
    ...
    public Boolean saveFormula(SaveFormulaDTO dto) {
        ...
        Boolean saved = componentMapper.saveOrUpdateFormula(componentList);
        if (Boolean.TRUE.equals(saved)) {
            auditOperationLogService.save(AuditOperationLogEntity.builder()
                    .module(AuditBusinessModule.METHOD_AUDIT.name())
                    .businessId(dto.getRecordVersionId())
                    .operationType(OperationType.FORMULA_CONFIG.getValue())
                    .remark(null)

 ...
 * 环境: dev/test/prod
 * 变更内容:
 * 1. 创建表 bm_execute_form_data
 * 2. 创建必要索引
 */

CREATE TABLE IF NOT EXISTS `bm_execute_form_data` (
  `id` bigint(20) NOT NULL COMMENT '主键ID',
  `value` varchar(2000) DEFAULT NULL COMMENT '数据值',
  `value_extension` longtext NULL COMMENT '扩展字段 前端使用',
  ...
  `inspect_item_id` bigint(20) DEFAULT NULL COMMENT '分析项ID',
  `inspect_item_config_id` bigint(20) DEFAULT NULL COMMENT '分析项配置ID',
  `inspect_parameter_id` bigint(20) DEFAULT NULL COMMENT '参数ID',
  `inspect_parameter_config_id` bigint(20) DEFAULT NULL COMMENT '参数配置ID',
  ...
  `review_user` varchar(64) DEFAULT NULL COMMENT '复核人',
  `review_time` datetime DEFAULT NULL COMMENT '复核时间',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  `rev` bigint(20) DEFAULT NULL COMMENT '修订版本号',
  `is_empty_value` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否空值',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='ELN 执行表单数据';

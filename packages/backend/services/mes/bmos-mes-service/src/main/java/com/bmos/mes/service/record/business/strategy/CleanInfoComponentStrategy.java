 ...
 * 清场信息组件
 */
@Component("CLEAN_INFO")
public class CleanInfoComponentStrategy implements BusinessComponentStrategy {
    @Override
    public void handleBusinessComponent(List<ExecuteFormData> results, ComponentListVO component,
        ...
        List<ComponentListVO> lastLevelComponent = Lists.newArrayList(component.getChildren());
    ...
    private String getValueByType(String type, FactoryRoomInfo factoryRoomInfo) {
        ...
        switch (enumByValue){
            ...
            case CLEAN_INFO_EXPIRATION_DATE:
            ...
            case CLEAN_INFO_CLEAN_PERSON:
                return factoryRoomInfo.getOperator();
            case CLEAN_INFO_CLEAN_DATE:
                return factoryRoomInfo.getCleanDate();
            case CLEAN_INFO_QUALITY_INSPECTION_PERSON:
                return factoryRoomInfo.getVerifier();
            case CLEAN_INFO_ROOM_QUALITY_INSPECTION_DATE:

...
public class PositionLogDivideShadingAlgorithm extends AbstractDivideShardingAlgorithm implements StandardShardingAlgorithm<LocalDateTime> {


    private static final String tableName = "bm_storage_material_position_log";

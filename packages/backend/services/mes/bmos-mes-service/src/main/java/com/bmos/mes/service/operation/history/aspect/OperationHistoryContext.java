...
public class OperationHistoryContext {

    private static final Logger log = LoggerFactory.getLogger(OperationHistoryContext.class);
    ...
    public interface VariableFunc<T, R> extends Serializable {
        ...
        default String getMethodName() {
            ...
            try {
                ...
                log.error("[OperationLogContext] 获取 [VariableFunc] 方法名错误：{}", e.getCause() + e.getMessage());
                throw new IllegalArgumentException("OperationLogContext lambda expression error");
            }
        }
    }
}

...
public class OperationLogDivideShadingAlgorithm extends AbstractDivideShardingAlgorithm implements StandardShardingAlgorithm<LocalDateTime> {


    private static final String tableName = "bm_operation_log";

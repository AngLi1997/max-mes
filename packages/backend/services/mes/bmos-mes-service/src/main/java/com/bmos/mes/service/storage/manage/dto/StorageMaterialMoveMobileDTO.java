 ...
 */
@Data
@ApiModel("暂存物料件移库参数（移动端）")
public class StorageMaterialMoveMobileDTO {
     ...
     * 移出货位
     */
    @ApiModelProperty(value = "移出货位", example = "1", required = true)
    @NotNull
    private Long sourceMaterialPositionId;

...
@Service
public class RecordAuditCondition extends AbstractAuditDataCondition {
    public RecordAuditCondition(PlatformApiAdaptor platformApiAdaptor, ProcessService processService, PlanService planService,

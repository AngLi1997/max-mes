...
public interface BatchRecordComponentService {
    ...
    List<BatchRecordComponent> getProcedureStepListRequiredConfigList(List<ProcedureStepModel> procedureStepModelList);

    List<BatchRecordComponent> getProcedureStepListConfigList(List<ProcedureStepModel> procedureStepModelList);
     ...
     * @return
     */
    List<ComponentDetailVO> selectByComponentDetailDTOS(List<ComponentDetailDTO> componentDetailDTOS);

 ...
 */
@Service(value = "OUTPUT_WEIGHING")
public class OutputWeighComponentStrategy implements BusinessComponentStrategy {

    @Resource
    private OutputWeighDetailComponentStrategy detailComponentStrategy;

    @Resource
    private OutputWeighSummaryComponentStrategy summaryComponentStrategy;
    ...
    public void handleBusinessComponent(List<ExecuteFormData> results, ComponentListVO component, ProductionDetailInfo info, Map<Long, BusinessComponentConfigDetailVO> configMap, Integer index) {
        ...
        List<ComponentListVO> details = childMap.get(BusinessComponentTypeEnum.OUTPUT_WEIGHING_DETAILS.getValue());
        ...
        List<ComponentListVO> summary = childMap.get(BusinessComponentTypeEnum.OUTPUT_WEIGHING_SUMMARY.getValue());

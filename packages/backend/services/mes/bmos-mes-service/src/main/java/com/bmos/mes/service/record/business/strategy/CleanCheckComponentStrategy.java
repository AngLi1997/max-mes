 ...
 * 清场信息组件
 */
@Component("CLEAN_CHECK")
public class CleanCheckComponentStrategy implements BusinessComponentStrategy {
    @Override
    ...
    private String getValueByType(String type, FactoryRoomInfo factoryRoomInfo) {
        ...
        switch (enumByValue){
            ...
            case CLEAN_CHECK_CLEAN_DATE:
                return factoryRoomInfo.getCleanDate();
            case CLEAN_CHECK_EXPIRATION_DATE:
            ...
            case CLEAN_CHECK_CLEAN_PERSON:
                return factoryRoomInfo.getOperator();
            case CLEAN_CHECK_QUALITY_INSPECTION_PERSON:
                return factoryRoomInfo.getVerifier();
            case CLEAN_CHECK_ROOM_QUALITY_INSPECTION_DATE:

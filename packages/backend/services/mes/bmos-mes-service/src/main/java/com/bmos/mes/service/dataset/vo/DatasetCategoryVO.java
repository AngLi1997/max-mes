...
@Data
@ApiModel("数据集分类vo")
public class DatasetCategoryVO implements BmosTreeNode<DatasetCategoryVO, Long, Long> {
    ...
    private List<DatasetCategoryVO> children;


    @Override
    public void addChild(BmosTreeNode<DatasetCategoryVO, Long, Long> child) {
        if (children == null) {
            children = new ArrayList<>();
        }
        children.add((DatasetCategoryVO) child);
    }

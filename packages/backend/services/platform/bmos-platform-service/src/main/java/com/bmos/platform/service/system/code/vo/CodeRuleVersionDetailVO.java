...
@Getter
@Setter
@ApiModel("CodeRuleVersionDetailVO:编码规则版本详情")
public class CodeRuleVersionDetailVO {
    ...
    public String getValue() {
        if (StrUtil.isNotEmpty(getDateType())) {
            return getDateType();
        }
        if (Objects.nonNull(getStartNo())) {
            return String.join(StrPool.DASHED, String.valueOf(getStartNo()), String.valueOf(getStep()), String.valueOf(getMaxLength()));
        }
        return value;
    }
}

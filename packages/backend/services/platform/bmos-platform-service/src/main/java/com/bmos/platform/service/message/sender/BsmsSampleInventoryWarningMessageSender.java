...
import com.bmos.platform.service.message.dto.BsmsSampleInventoryWarningMessageContext;
...
@Service
public class BsmsSampleInventoryWarningMessageSender extends DefaultMessageSender{
    ...
    protected String getTitle(MessageTemplate messageTemplate, MessageContextDTO messageContextDTO) {
        BsmsSampleInventoryWarningMessageContext context = (BsmsSampleInventoryWarningMessageContext) messageContextDTO;
    ...
    protected MessageTypeEnum getMessageType() {
        return MessageTypeEnum.BSMS_SAMPLE_INVENTORY_WARNING;
    }

    @Override
    protected Collection<String> getReceiveUserIds(MessageContextDTO messageContextDTO) {
        return roleService.authUserList(MessageTypeEnum.BSMS_SAMPLE_INVENTORY_WARNING.getAuthorityCode())
